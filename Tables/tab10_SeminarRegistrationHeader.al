table 50110 "CSD Seminar Reg. Header"
{
    ...
    fields
    {
            ...
            begin
                if "Room Code" = '' then begin
                    ...
                    if (CurrFieldNo <> 0) then begin
                        if (SeminarRoom."BAL Maximiun Party Pants" <> 0) and
                           (SeminarRoom."BAL Maximiun Party Pants" < "Maximum Participants")
                        then begin
                            if Confirm(Text004, true,
                                 "Maximum Participants",
                                 SeminarRoom."BAL Maximiun Party Pants",
                                 FieldCaption("Maximum Participants"),
                                 "Maximum Participants",
                                 SeminarRoom."BAL Maximiun Party Pants")
                            then
                                "Maximum Participants" := SeminarRoom."BAL Maximiun Party Pants";
                        end;
                    end;
                end;
            end;
        ...
        {
            CalcFormula = Exist ("BAL Seminar Comment Line" where ("Table Name" = const (Seminar),
                                                              "No." = Field ("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        ...
        field(27; "Posting No. Series"; Code[10])
        {
            ...
            begin
                with SeminarRegHeader do begin
                    ...
                    SeminarSetup.TestField("No. Series Posted");
                    if NoSeriesMgt.LookupSeries(SeminarSetup."No. Series Posted", "Posting No. Series")
                    then begin
            ...
            begin
                if "Posting No. Series" <> '' then begin
                    ...
                    SeminarSetup.TestField("No. Series");
                    SeminarSetup.TestField("No. Series Posted");
                    NoSeriesMgt.TestSeries(SeminarSetup."No. Series Posted", "Posting No. Series");
                end;
    ...
    begin
        if "No." = '' then begin
            SeminarSetup.GET;
            SeminarSetup.TestField("No. Series Posted");
            NoSeriesMgt.InitSeries(SeminarSetup."No. Series Posted", xRec."No. Series", 0D, "No.", "No. Series");
        end;
        ...
        SeminarSetup.GET;
        NoSeriesMgt.SetDefaultSeries("Posting No. Series", SeminarSetup."No. Series Posted");
    end;
    ...
    begin
        with SeminarRegHeader do begin
            ...
            SeminarSetup.GET;
            SeminarSetup.TestField("No. Series");
            if NoSeriesMgt.SelectSeries(SeminarSetup."No. Series", OldSeminarRegHeader."No. Series", "No. Series") then begin
                SeminarSetup.GET;
                SeminarSetup.TestField("No. Series");
